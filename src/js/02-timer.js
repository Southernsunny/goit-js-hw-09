...
Notiflix.Report.info(' 🤟🏼 Hello my Friend!', 'Please, choose a date and click on start', 'Okay');
...
flatpickr(dateTimePicker, {
  ...
  onClose(selectedDates) {
    ...
    const now = new Date();
    if (selectedDate < now) {
      Notiflix.Report.failure('Oppss...🧟‍♂️', 'Please choose a date in the future', 'Try again');
      strBtn.disabled = true;
    } else {
